    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo site_url($this->session->userdata('role')); ?>" class="topnav-logo" style = "min-width: unset;">
            <span class="topnav-logo-lg">
                <img src="<?php echo base_url('uploads/'.$this->config->item('upload_directory').'/system/logo-light.png');?>" alt="" height="40">
            </span>
            <span class="topnav-logo-sm">
                <img src="<?php echo base_url('uploads/'.$this->config->item('upload_directory').'/system/logo-light-sm.png');?>" alt="" height="40">
            </span>
        </a>
