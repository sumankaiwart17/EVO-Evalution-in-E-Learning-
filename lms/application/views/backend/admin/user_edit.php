                            ...
                            <div class="tab-pane" id="login_credentials">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="email"> <?php echo get_phrase('block'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <select multiple class="form-control" id="exampleFormControlSelect1" name="block">
                                                  <option value="1" <?php if($user_data['block']==1) echo 'selected' ?>>Yes</option>
                                                  <option value="0" <?php if($user_data['block']==0) echo 'selected' ?>>No</option>
                                                </select>
