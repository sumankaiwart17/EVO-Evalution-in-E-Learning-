            ...
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/system_settings/system_update'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="footer_link"><?php echo get_phrase('facebook_app_id'); ?></label>
                            <input type="text" name = "facebook_app_id" id = "facebook_app_id" class="form-control" value="<?php echo get_settings('facebook_app_id');  ?>">
                        </div>
                        <div class="form-group">
                            <label for="facebook_app_secret"><?php echo get_phrase('facebook_app_secret'); ?></label>
                            <input type="text" name = "facebook_app_secret" id = "facebook_app_secret" class="form-control" value="<?php echo get_settings('facebook_app_secret');  ?>">
                        </div>

                        <div class="form-group">
                            <label for="google_client_id"><?php echo get_phrase('google_client_id'); ?></label>
                            <input type="text" name = "google_client_id" id = "google_client_id" class="form-control" value="<?php echo get_settings('google_client_id');  ?>">
                        </div>

                        <div class="form-group">
                            <label for="google_client_secret"><?php echo get_phrase('google_client_secret'); ?></label>
                            <input type="text" name = "google_client_secret" id = "google_client_secret" class="form-control" value="<?php echo get_settings('google_client_secret');  ?>">
                        </div>
