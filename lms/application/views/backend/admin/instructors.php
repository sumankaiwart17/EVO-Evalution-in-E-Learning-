                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo get_phrase('block'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($user['block'] == 1): ?>
                                    <small><p><span class="badge badge-danger-lighten"><?php echo get_phrase('Block'); ?></span></p></small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <div class="dropright dropright">
                                        ...
                                        $email_hash =  $hash;
                                      ?>
                                      <li><a class="dropdown-item" href="<?php echo site_url('login/login_sso/'.$email_hash) ?>"><?php echo get_phrase('Login'); ?></a></li>
