                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <?php if (!empty($pending_application['document'])): ?>
                                                    <a href="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/document/'.$pending_application['document']; ?>" class="btn btn-info" download>
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <?php if (!empty($approved_application['document'])): ?>
                                                    <a href="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/document/'.$approved_application['document']; ?>" class="btn btn-info" download>
                                                        <i class="fa fa-download"></i> <?php echo get_phrase('download'); ?>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
