            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#">
                        <img src="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/system/logo-dark.png'; ?>" alt="" height="35">
                    </a>
                    ...
                    <div class="user-box menu-icon-box">
                        <div class="icon">
                            <a href="javascript::">
                                <?php
                                if (file_exists('uploads/'.$this->config->item('upload_directory').'/user_image/'.$user_details['id'].'.jpg')): ?>
                                <img src="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/user_image/'.$user_details['id'].'.jpg';?>" alt="" class="img-fluid">
                            <?php else: ?>
                                <img src="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/user_image/placeholder.png';?>" alt="" class="img-fluid">
                            <?php endif; ?>
                        </a>
                    </div>
                                ...
                                <a href="">
                                    <div class="clearfix">
                                        <div class="user-image float-left">
                                            <?php if (file_exists('uploads/'.$this->config->item('upload_directory').'/user_image/'.$user_details['id'].'.jpg')): ?>
                                                <img src="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/user_image/'.$user_details['id'].'.jpg';?>" alt="" class="img-fluid">
                                            <?php else: ?>
                                                <img src="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/user_image/placeholder.png';?>" alt="" class="img-fluid">
                                            <?php endif; ?>
