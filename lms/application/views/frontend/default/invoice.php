...
<section class="page-header-area my-course-area d-print-none">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="page-title" style="color: #fff;"><?php echo site_phrase('invoice'); ?></h1>
                <ul>
                    ...
                    <li class="active"><a href="<?php echo site_url('home/purchase_history'); ?>"><?php echo site_phrase('purchase_history'); ?></a></li>
...
<section class="purchase-history-list-area">
    <div class="container">
                ...
                <div style="margin-left:auto;margin-right:auto;">
                    ...
                    <div style="background: #eceff4;padding: 1.5rem;">
                        <table>
                            <tr>
                                <td>
                                    <img src="<?php echo base_url('uploads/'.$this->config->item('upload_directory').'/system/logo-dark.png');?>" height="40" style="display:inline-block;">
                                </td>
        ...
        <div class="d-print-none mb-2">
            <a href="javascript:window.print()" class="btn btn-receipt"><?php echo site_phrase('print'); ?></a>
        </div>
    </div>
</section>
