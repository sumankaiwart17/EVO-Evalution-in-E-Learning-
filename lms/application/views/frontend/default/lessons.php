        ...
        <?php if (isset($lesson_id)): ?>
            <div class="col-lg-9" id = "video_player_area">
                ...
                <div class="" style="text-align: center;">
                    ...
                    <?php else: ?>
                        <div class="mt-5">
                            <a href="<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/lesson_files/'.$lesson_details['attachment']; ?>" class="btn btn-sign-up" download style="color: #fff;">
                                <i class="fa fa-download" style="font-size: 20px;"></i> <?php echo site_phrase('download').' '.$lesson_details['title']; ?>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="" style="margin: 20px 0;" id = "lesson-summary">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $lesson_details['lesson_type'] == 'quiz' ? site_phrase('instruction') : site_phrase("note"); ?>:</h5>
                                    <?php if ($lesson_details['summary'] == ""): ?>
                                        <p class="card-text"><?php echo $lesson_details['lesson_type'] == 'quiz' ? site_phrase('no_instruction_found') : site_phrase("no_summary_found"); ?></p>
                                    <?php else: ?>
