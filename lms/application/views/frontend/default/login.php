                  ...
                  <div class="user-dashboard-content w-100 login-form">
                      ...
                      <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                          ...
                          <div class="content-update-box">
                              <button type="submit" class="btn"><?php echo site_phrase('login'); ?></button> </br>
                              <a href="<?php echo $authURL; ?>"><img style="width: 247px;" src="<?php echo base_url('assets/images/fb-login-btn.png'); ?>"></a>
                              <a href="<?php echo $loginURL; ?>"><img style="    width: 185px;" src="<?php echo base_url().'assets/images/glogin.png'; ?>" /></a>
                          </div>
