    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <ul>
                  <li class="active"><a href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('all_courses'); ?></a></li>
...
function getCourseDetailsForRatingModal(course_id) {
    $.ajax({
        ...
        success : function(response){
            ...
            $('#course_thumbnail_1').attr('src', "<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/thumbnails/course_thumbnails/';?>"+course_id+".jpg");
            $('#course_thumbnail_2').attr('src', "<?php echo base_url().'uploads/'.$this->config->item('upload_directory').'/thumbnails/course_thumbnails/';?>"+course_id+".jpg");
